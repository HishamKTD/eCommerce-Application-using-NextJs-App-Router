      ...
      <div className="row mb-3">
        <div className="col-3 row m-0 ps-2 pe-2">
          <div className="bg-white pt-4 pb-4 shadow">
            <h5 className="col-12 fw-bold ps-2 mb-4">
            ...
            <div className="col-12 row m-0 mb-3">
              <div className="col-6 row m-0">
                <Image
                  src={PrdGalleryImg01}
                  className="p-0"
                  alt={"Cushion covers, bedsheets & more"}
                />
                <span className="p-0" style={{ fontSize: "12px" }}>
            ...
            <Link className="ms-3" style={{ fontSize: "14px" }} href={"/"}>
              Explore all
            </Link>
          </div>
        </div>
