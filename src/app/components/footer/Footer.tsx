      ...
      <div className={Style.footrContactSection}>
        <div className={Style.footerLinkSection}>
          <div className={Style.footerLinkBox}>
            ...
            <Link href="https://stories.flipkart.com/" target="_blank">
              Stories
            </Link>
            <Link
              href="https://stories.flipkart.com/category/top-stories/news/"
              target="_blank"
            >
              Press
            </Link>
            <Link href="/corporate-information" target="_blank">
              Corpration Information
            </Link>
          </div>
          <div className={Style.footerLinkBox}>
            <div className={Style.footerLinkHead}>HELP</div>
            <Link href="/pages/payments" target="_blank">
              Payments
            </Link>
            <Link href="/pages/shipping" target="_blank">
              Shipping
            </Link>
            <Link
          ...
          <div className={Style.footerLinkBox}>
            ...
            <Link href="/sitemap?otracker=${otracker}_navlinks" target="_blank">
              Sitemap
            </Link>
            <Link
        ...
        <div className={Style.footerAddressSection}>
          ...
          <div className={Style.footerAddressContainer}>
            <div className={Style.addressHead}>Registered Office Address:</div>
            <div className={Style.address}>
              Flipkart Internet Private Limited, Buildings Alyssa, Begonia &
              Clove Embassy Tech Village, Outer Ring Road, Devarabeesanahalli
