    ...
    <div className="row">
      {cartTotalPrice < 100 ? (
        <div className="col-12">
          <p>
            Add <label className="text-danger"> ${500 - cartTotalPrice} </label>{" "}
      ...
      <div className="p-3 pb-1">
        <h5>
          Subtotal ( {numOfCartItems} item): ${cartTotalPrice}
        </h5>
        <button className="btn btn-primary w-100 text-white fw-medium">
          Proceed to Buy{" "}
        </button>
      </div>
    </div>
